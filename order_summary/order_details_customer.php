    ...
    <body>
        <div class="container">
			...
			<section class="main">
				...
				<h1><span class="order_count">YOUR ORDER DETAILS</span></h1> 
				<h3> You can make PAYMENT to this </br>Maybank Account:<br/>
				 
					Acc Name:Hakikat Jati Resources Sdn. Bhd.<br/>
					Acc No. :562263026130 <br/>
					*Please send the receipt payment to 011-60544647<br/>
					</h3> 
				...
				<?php   $arr = mysqli_fetch_array($res);  ?>
				<form class="form-2"  method="post">
					<h1><span class="log-in">Date/Time Order: <?php	echo date("d-M-Y h:i A",strtotime($arr['date_order']));	?>	</span></h1>
					...
					<p class="clearfix"> 
						...
						<br/>
				 	<a href="#" onclick="window.print();" class="log-twitter">PRINT</a> 
